...
public class CodeGenerator {
    public static void main(String[] args) {
        DataSourceConfig dataSourceConfig = new DataSourceConfig
                .Builder("jdbc:mysql://localhost:3306/db_hrm?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2b8", "root", "root")
                // 数据库字段类型转换
        ...
        GlobalConfig globalConfig = new GlobalConfig.Builder()
                ...
                .outputDir("E:\\Project\\crm\\crm\\src\\main\\java")  // 输出路径为当前项目的/src/main/java目录下
                .author("gaoziman")
        ...
        PackageConfig packageConfig = new PackageConfig.Builder()
                .parent("com.manman.crm")
                .entity("pojo")
                .service("service")
                .serviceImpl("service.impl")
                .mapper("mapper")
                .controller("controller")
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "E:\\Project\\crm\\crm\\src\\main\\resources\\mapper")) // 设置mapperXml生成路径
                .build();

        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                .addTablePrefix("sys_", "per_", "soc_", "sal_", "att_", "act_re_", "sal_") // 根据表名生成实体名，去除指定的表前缀
                .addInclude("sys_staff")
